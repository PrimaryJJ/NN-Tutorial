...
from activators import ReluActivator, IdentityActivator, SigmoidActivator
...
class RecurrentLayer(object):
    ...
    def backward(self, sensitivity_array, 
        ...
        实现BPTT算法
        '''
        self.calcn_delta(sensitivity_array, activator)
        self.calc_gradient()
    ...
    def calcn_delta(self, sensitivity_array, activator):
